...
#X.entity <- readRDS(paste(out.dir,"/RData/X.",dataset,".rds",sep=""))
#M.entity <- readRDS(paste(out.dir,"/RData/M.",dataset,".rds",sep=""))
#STAT.entity <- readRDS(paste(out.dir,"/RData/STAT.",dataset,".rds",sep=""))
...
genebody.2kb <- (promoters(genes,upstream=0,downstream=5000))
